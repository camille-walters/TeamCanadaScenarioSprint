...
namespace ThetaList
{
    ...
    public partial class OperationTree<T>
    {
        ...
        public IEnumerable<OperationNode> OperationData()
        {
            return OperationData(new OperationNode(), false);
        }
        /// <summary>
        ...
        /// <returns></returns>
        public IEnumerable<OperationNode> OperationData(OperationNode lastOp,bool callLast = true)
        {
            if (mRoot == null || mRoot == NIL)
            {
                if(callLast)
        ...
        public int Weight(OperationType op)    // returns the weight of an operation. This is the value at which larger indices are pushed
        {
            switch (op)
            {
