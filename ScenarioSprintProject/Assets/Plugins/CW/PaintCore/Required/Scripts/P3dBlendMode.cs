...
namespace PaintIn3D
{
	...
	public struct P3dBlendMode
	{
		...
		public static P3dBlendMode NormalReplaceOriginal(Vector4 channels) { return new P3dBlendMode() { Index = NORMAL_REPLACE_ORIGINAL, Color = Color.white, Kernel = 1.0f, Channels = channels }; }
		public static P3dBlendMode NormalReplaceCustom(Color color, Texture texture, Vector4 channels) { return new P3dBlendMode() { Index = NORMAL_REPLACE_CUSTOM, Color = color, Texture = texture, Kernel = 1.0f, Channels = channels }; }

		public static P3dBlendMode Min(Vector4 channels) { return new P3dBlendMode() { Index = MIN, Color = Color.white, Kernel = 1.0f, Channels = channels }; }

		public static P3dBlendMode Max(Vector4 channels) { return new P3dBlendMode() { Index = MAX, Color = Color.white, Kernel = 1.0f, Channels = channels }; }
...
namespace PaintIn3D
{
	...
	public class P3dBlendMode_Drawer : PropertyDrawer
	{
		public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
		{
			...
			if (index == P3dBlendMode.REPLACE_CUSTOM || index == P3dBlendMode.NORMAL_REPLACE_CUSTOM)
			{
				height += step * 2;
			}
		...
		public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label)
		{
			...
			EditorGUI.indentLevel++;
				...
				if (sIdx.intValue == P3dBlendMode.REPLACE_CUSTOM || sIdx.intValue == P3dBlendMode.NORMAL_REPLACE_CUSTOM)
				{
